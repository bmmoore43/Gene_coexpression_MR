...
# Define function for calculating SCCs
def sub_fork(subgeneList):
    
    for gene1 in subgeneList:
        sccs = {}
        for gene2 in geneDict:
            corr,_ = spearmanr(geneDict[gene1], geneDict[gene2])
...
for i in range(forks):
    ...
    if pid == 0:
        ...
        print("  thread", tct, ": Calculating SCCs for", len(subgeneList), 'genes...') 
...
for i in range(forks):
    ...
    print("  thread", tct, ": Finished calculating SCCs!") 
